	...
	return (
		<section
			...
			style={{
				backgroundImage:
					theme === 'light'
						? `linear-gradient(rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0.1)), url(${backgroundImage})`
			...
			<div className='container mx-auto px-4 py-20 text-center relative z-10'>
				<div
					className='max-w-4xl mx-auto bg-white/40 dark:bg-transparent backdrop-blur-sm rounded-lg p-8 border border-gray-300 dark:border-gray-700
'>
					<div className='mb-8 animate-fade-in'>
						<h1 className='text-5xl md:text-7xl font-bold mb-4 text-black dark:text-foreground'>expert-komp</h1>
						<div className='flex items-center justify-center gap-2 mb-6'>
							<div className='h-1 w-12 bg-primary'></div>
							<p className='text-2xl md:text-3xl text-primary font-semibold'>pogotowie komputerowe</p>
							<div className='h-1 w-12 bg-primary'></div>
						</div>
					</div>
