			...
			<div className='container mx-auto px-4'>
				...
				<div className='max-w-4xl mx-auto'>
							...
							<div className='bg-card p-6 rounded-lg border border-border hover:border-primary transition-colors'>
								<div className='flex items-start gap-4'>
									...
									<div>
										...
										<a href='mailto:serwis@expert-komp.pl' className='text-lg text-primary hover:underline'>
											serwis@expert-komp.pl
										</a>
									</div>
								</div>
							</div>
					...
					<div className='text-center bg-card p-8 rounded-lg border border-primary'>
						<h3 className='text-2xl font-bold mb-4 text-card-foreground'>Potrzebujesz pomocy?</h3>
						<p className='text-muted-foreground mb-6'>Skontaktuj się z nami telefonicznie – jesteśmy gotowi pomóc!</p>
						<Button
							size='lg'
							className='bg-primary hover:bg-primary/90 text-primary-foreground text-lg px-4 py-4 w-full'
