...
const Services = () => {
	const services = [
		...
		},
		{
			...
			description:
				'Projektujemy nowoczesne i estetyczne strony internetowe typu portfolio, które profesjonalnie prezentują ofertę Twojej firmy.',
		},
		{
			icon: Headphones,
		...
		<section id='services' className='py-20 bg-background'>
			<div className='container mx-auto px-4'>
				<div className='text-center mb-16'>
					<h2 className='text-4xl md:text-5xl font-bold mb-6 text-foreground'>Nasza oferta</h2>
